...
func (_m *UserServiceInterface) Create(input users.Core) error {
	ret := _m.Called(input)
...
func (_m *UserServiceInterface) GetAll() ([]users.Core, error) {
	ret := _m.Called()
...
func (_m *UserServiceInterface) Login(email string, password string) (users.Core, string, error) {
